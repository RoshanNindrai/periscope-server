...
return [
    ...
    */
    ...
    'security' => [
        // 0 = disabled. Set to e.g. 1000 to reject overly complex queries (DoS mitigation).
        'max_query_complexity' => (int) env('LIGHTHOUSE_MAX_QUERY_COMPLEXITY', 0),
        // 0 = disabled. Set to e.g. 15 to reject deeply nested queries (DoS mitigation).
        'max_query_depth' => (int) env('LIGHTHOUSE_MAX_QUERY_DEPTH', 0),
    ...
    */
    ...
    'error_handlers' => [
        App\GraphQL\ErrorHandlers\AuthenticationErrorHandlerWithCode::class,
        App\GraphQL\ErrorHandlers\AuthorizationErrorHandlerWithCode::class,
        App\GraphQL\ErrorHandlers\ValidationErrorHandlerWithCode::class,
